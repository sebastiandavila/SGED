...
<div class="container">
    <form id="formularioEditarFaseAct" method="POST" action="auxiliarconsultapagosM.jsp">
            <div class="form-group">
                
                <div>
                    
                    <input id="a" name="a" class="form-control"  placeholder="Año" type="text" ><br>
                    <input id="mes" name="mes" class="form-control"  placeholder="mes indicado en numeros" type="text" ><br>
                </div>
