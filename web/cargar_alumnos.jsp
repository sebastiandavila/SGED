...
<html>
    <head>
     ...
     <body>
            ...
            <div class="container">
                <h8 href="#page-top" >SGED</h8>    <ul class="nav justify-content-end">
                        ...
                        <li class="nav-item">
                          ...
                          <a class="nav-link" href="inicioSesion.jsp"><span7 class="icon-exit"> </span7></a>
                        </li>
                      </ul>                                                                 
        ...
        <br>
        <center>
         <h9>Cargar alumnos</h9>
    </center>
         <br>
        
<div class="container">
    <form action="auxiliarCrearU.jsp">
                <input type="file" name="archivo" id="archivo">
                <input type="submit" value="Subir listado">
            </form>
</div>
